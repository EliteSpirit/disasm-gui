...
print(f"""VSVersionInfo(
  ...
  kids=[
    StringFileInfo([StringTable('040904B0', [
      ...
      StringStruct('FileDescription', 'Disasm GUI'),
      StringStruct('FileVersion', '{version}'),
      StringStruct('InternalName', 'DisasmGUI'),
      StringStruct('LegalCopyright', 'MIT License, EliteSpirit'),
      StringStruct('OriginalFilename', 'DisasmGUI.exe'),
      StringStruct('ProductName', 'Disasm GUI'),
